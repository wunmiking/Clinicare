import { roomStatus, roomType } from "@/utils/constants";
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-2 space-y-4">
                ...
                >
                  ...
                  {Object.entries(roomType)?.map((item, index) => (
                ...
                >
                  ...
                  {Object.entries(roomStatus)?.map((item, index) => (
                    <option key={index} value={item}>
                      {item[1]}
                    </option>
                  ))}
